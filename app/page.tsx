...
export default async function Home() {
  ...
  return <>
    <section className="hero"><div className="hero-orb orb-one" /><div className="hero-orb orb-two" /><div className="shell hero-grid"><div className="hero-copy"><p className="eyebrow"><Sparkles size={15} /> Nigeria’s local artist directory</p><h1>Find Local Artists<br /><em>and Painters in Nigeria</em></h1><p className="hero-lead">Find verified artists near you for custom portraits, murals, live event painting and original Nigerian artwork. Browse portfolios and contact artists directly.</p><div className="hero-actions"><Link className="button" href="/find-artists">Find Artists Near You <ArrowRight size={18} /></Link><Link className="text-link" href="/apply">List Your Art Business</Link></div><div className="trust-row"><span><ShieldCheck size={18} /> Personally verified</span><span><MapPin size={18} /> All 36 states + FCT</span></div></div><div className="hero-art" aria-hidden="true"><div className="frame frame-back"><span>Made<br />in<br />Nigeria</span></div><div className="frame frame-front"><div className="portrait-shape"><i /></div><p>Art with a story</p></div><div className="paint-mark">✦</div></div></div></section>
